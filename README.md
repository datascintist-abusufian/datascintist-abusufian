...
- **AI-driven thoracic X-ray diagnostics: transformative transfer learning for clinical validation in pulmonary radiography.** *Journal of Personalized Medicine* 14(8), 856 (2024).
- **Mitigating algorithmic bias in AI-driven cardiovascular imaging for fairer diagnostics.** *Diagnostics* 14(23), 2675 (2024).
- **Enhancing clinical validation for early cardiovascular disease prediction through simulation, AI and web technology.** *Diagnostics* 14(12), 1308 (2024).
